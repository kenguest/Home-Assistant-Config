...
#### <a name="zigbee-sensors"></a> Sensors ####
...
#### <a name="zigbee-switches"></a> Switches ####
| Model                                                        | Zigbee Device Compatibility Reference  | Buy  | Image                                                                              | Quantity | Notes                                                        | Battery Type |
|--------------------------------------------------------------|------|------|------------------------------------------------------------------------------------|----------|--------------------------------------------------------------|----|
...
#### <a name="zigbee-plugs"></a> Power plugs/monitoring ####
...
#### <a name="zigbee-lighting"></a> Lighting ####
...
| Eglo Dimmable Warm White Vintage styled E27 Bulb  | [TLSR82xx](https://zigbee.blakadder.com/AwoX_33948.html)  | [Amazon.co.uk](https://www.amazon.co.uk/-/en/gp/product/B09FTBSCGW/ref=ppx_yo_dt_b_asin_title_o00_s00?ie=UTF8&th=1)     | <img src="https://zigbee.blakadder.com/assets/images/devices/AwoX_33948.jpg">  | 2        | Lights in kitchen.   |
...
### <a name="software-integrations"></a> Integrations ###
